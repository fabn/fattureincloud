...
# Unit tests for FattureInCloud::MagazzinoApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MagazzinoApi' do
  before do
    # run before each test
    @instance = FattureInCloud::MagazzinoApi.new
  end
  ...
  describe 'test an instance of MagazzinoApi' do
    it 'should create an instance of MagazzinoApi' do
      expect(@instance).to be_instance_of(FattureInCloud::MagazzinoApi)
    end
  end

  # unit tests for arrivi_dettagli
  # Dettagli arrivo merce
  # Restituisce i dettagli dell&#39;arrivo merce richiesto.
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [ArriviDettagliResponse]
  describe 'arrivi_dettagli test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for arrivi_lista
  # Elenco arrivi merce
