...
# Unit tests for FattureInCloud::InfoApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InfoApi' do
  before do
    # run before each test
    @instance = FattureInCloud::InfoApi.new
  end
  ...
  describe 'test an instance of InfoApi' do
    it 'should create an instance of InfoApi' do
      expect(@instance).to be_instance_of(FattureInCloud::InfoApi)
    end
  end

  # unit tests for info_lista
  # Informazioni
