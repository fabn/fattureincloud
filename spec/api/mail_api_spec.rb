...
# Unit tests for FattureInCloud::MailApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MailApi' do
  before do
    # run before each test
    @instance = FattureInCloud::MailApi.new
  end
  ...
  describe 'test an instance of MailApi' do
    it 'should create an instance of MailApi' do
      expect(@instance).to be_instance_of(FattureInCloud::MailApi)
    end
  end

  # unit tests for mail_lista
  # Elenco mail
