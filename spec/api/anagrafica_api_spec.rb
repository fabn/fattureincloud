...
# Unit tests for FattureInCloud::AnagraficaApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AnagraficaApi' do
  before do
    # run before each test
    @instance = FattureInCloud::AnagraficaApi.new
  end
  ...
  describe 'test an instance of AnagraficaApi' do
    it 'should create an instance of AnagraficaApi' do
      expect(@instance).to be_instance_of(FattureInCloud::AnagraficaApi)
    end
  end

  # unit tests for anagrafica_elimina
  ...
  describe 'anagrafica_elimina test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for anagrafica_lista
  ...
  describe 'anagrafica_lista test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for anagrafica_modifica
  ...
  # @param [Hash] opts the optional parameters
  # @return [GenericSuccessResponse]
  describe 'anagrafica_modifica test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for anagrafica_nuovo_lista
  ...
  # @param [Hash] opts the optional parameters
  # @return [GenericSuccessResponse]
  describe 'anagrafica_nuovo_lista test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for anagrafica_nuovo_singolo
  ...
  describe 'anagrafica_nuovo_singolo test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
