...
# Unit tests for FattureInCloud::RichiestaGenericaApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RichiestaGenericaApi' do
  before do
    # run before each test
    @instance = FattureInCloud::RichiestaGenericaApi.new
  end
  ...
  describe 'test an instance of RichiestaGenericaApi' do
    it 'should create an instance of RichiestaGenericaApi' do
      expect(@instance).to be_instance_of(FattureInCloud::RichiestaGenericaApi)
    end
  end

  # unit tests for j_son_request
  ...
  # @return [nil]
  describe 'j_son_request test' do
    it 'should work' do
