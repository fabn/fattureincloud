...
# Unit tests for FattureInCloud::CorrispettiviApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CorrispettiviApi' do
  before do
    # run before each test
    @instance = FattureInCloud::CorrispettiviApi.new
  end
  ...
  describe 'test an instance of CorrispettiviApi' do
    it 'should create an instance of CorrispettiviApi' do
      expect(@instance).to be_instance_of(FattureInCloud::CorrispettiviApi)
    end
  end

  # unit tests for corrispettivi_elimina
  # Elimina registrazione
  # Elimina definitivamente un corrispettivo.
  # @param body Corpo richiesta
  # @param [Hash] opts the optional parameters
  # @return [GenericSuccessResponse]
  describe 'corrispettivi_elimina test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for corrispettivi_lista
  ...
  describe 'corrispettivi_lista test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for corrispettivi_modifica
  ...
  describe 'corrispettivi_modifica test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for corrispettivi_nuovo
  # Nuova registrazione
  # Aggiunge un nuovo corrispettivo. In caso di parametri non specificati vengono assunti quelli predefiniti.
  # @param body Corpo richiesta
  # @param [Hash] opts the optional parameters
  # @return [CorrispettiviNuovoResponse]
  describe 'corrispettivi_nuovo test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
