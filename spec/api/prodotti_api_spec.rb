...
# Unit tests for FattureInCloud::ProdottiApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProdottiApi' do
  before do
    # run before each test
    @instance = FattureInCloud::ProdottiApi.new
  end
  ...
  describe 'test an instance of ProdottiApi' do
    it 'should create an instance of ProdottiApi' do
      expect(@instance).to be_instance_of(FattureInCloud::ProdottiApi)
    end
  end

  # unit tests for prodotti_elimina
  # Elimina prodotto
  # Elimina definitivamente un prodotto.
  # @param body Corpo richiesta
  # @param [Hash] opts the optional parameters
  # @return [GenericSuccessResponse]
  describe 'prodotti_elimina test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for prodotti_lista
  # Elenco prodotti
  ...
  describe 'prodotti_lista test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for prodotti_modifica
  # Modifica prodotto
  ...
  # @param [Hash] opts the optional parameters
  # @return [GenericSuccessResponse]
  describe 'prodotti_modifica test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for prodotti_nuovo_lista
  ...
  # @param [Hash] opts the optional parameters
  # @return [GenericSuccessResponse]
  describe 'prodotti_nuovo_lista test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for prodotto_nuovo_singolo
  ...
  describe 'prodotto_nuovo_singolo test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
