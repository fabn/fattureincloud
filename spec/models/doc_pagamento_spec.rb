...
# Unit tests for FattureInCloud::DocPagamento
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DocPagamento' do
  before do
    # run before each test
    @instance = FattureInCloud::DocPagamento.new
  end
  ...
  describe 'test an instance of DocPagamento' do
    it 'should create an instance of DocPagamento' do
      expect(@instance).to be_instance_of(FattureInCloud::DocPagamento)
    end
  end
