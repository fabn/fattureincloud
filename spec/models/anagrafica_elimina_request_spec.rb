...
# Unit tests for FattureInCloud::AnagraficaEliminaRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AnagraficaEliminaRequest' do
  before do
    # run before each test
    @instance = FattureInCloud::AnagraficaEliminaRequest.new
  end
  ...
  describe 'test an instance of AnagraficaEliminaRequest' do
    it 'should create an instance of AnagraficaEliminaRequest' do
      expect(@instance).to be_instance_of(FattureInCloud::AnagraficaEliminaRequest)
    end
  end
