...
# Unit tests for FattureInCloud::DocArticolo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DocArticolo' do
  before do
    # run before each test
    @instance = FattureInCloud::DocArticolo.new
  end
  ...
  describe 'test an instance of DocArticolo' do
    it 'should create an instance of DocArticolo' do
      expect(@instance).to be_instance_of(FattureInCloud::DocArticolo)
    end
  end
  ...
  describe 'test attribute "valore_iva"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "desc_iva"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
