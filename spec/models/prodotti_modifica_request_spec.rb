...
# Unit tests for FattureInCloud::ProdottiModificaRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProdottiModificaRequest' do
  before do
    # run before each test
    @instance = FattureInCloud::ProdottiModificaRequest.new
  end
  ...
  describe 'test an instance of ProdottiModificaRequest' do
    it 'should create an instance of ProdottiModificaRequest' do
      expect(@instance).to be_instance_of(FattureInCloud::ProdottiModificaRequest)
    end
  end
