...
# Unit tests for FattureInCloud::DocDettagliRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DocDettagliRequest' do
  before do
    # run before each test
    @instance = FattureInCloud::DocDettagliRequest.new
  end
  ...
  describe 'test an instance of DocDettagliRequest' do
    it 'should create an instance of DocDettagliRequest' do
      expect(@instance).to be_instance_of(FattureInCloud::DocDettagliRequest)
    end
  end
