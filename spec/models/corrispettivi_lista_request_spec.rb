...
# Unit tests for FattureInCloud::CorrispettiviListaRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CorrispettiviListaRequest' do
  before do
    # run before each test
    @instance = FattureInCloud::CorrispettiviListaRequest.new
  end
  ...
  describe 'test an instance of CorrispettiviListaRequest' do
    it 'should create an instance of CorrispettiviListaRequest' do
      expect(@instance).to be_instance_of(FattureInCloud::CorrispettiviListaRequest)
    end
  end
  ...
  describe 'test attribute "tipo"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["ricevute", "spese"])
