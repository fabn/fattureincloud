...
# Unit tests for FattureInCloud::MailListaRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MailListaRequest' do
  before do
    # run before each test
    @instance = FattureInCloud::MailListaRequest.new
  end
  ...
  describe 'test an instance of MailListaRequest' do
    it 'should create an instance of MailListaRequest' do
      expect(@instance).to be_instance_of(FattureInCloud::MailListaRequest)
    end
  end
  describe 'test attribute "filtro"' do
    it 'should work' do
