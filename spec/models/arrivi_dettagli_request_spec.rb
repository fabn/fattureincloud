...
# Unit tests for FattureInCloud::ArriviDettagliRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ArriviDettagliRequest' do
  before do
    # run before each test
    @instance = FattureInCloud::ArriviDettagliRequest.new
  end
  ...
  describe 'test an instance of ArriviDettagliRequest' do
    it 'should create an instance of ArriviDettagliRequest' do
      expect(@instance).to be_instance_of(FattureInCloud::ArriviDettagliRequest)
    end
  end
