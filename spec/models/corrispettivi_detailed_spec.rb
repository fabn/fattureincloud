...
# Unit tests for FattureInCloud::CorrispettiviDetailed
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CorrispettiviDetailed' do
  before do
    # run before each test
    @instance = FattureInCloud::CorrispettiviDetailed.new
  end
  ...
  describe 'test an instance of CorrispettiviDetailed' do
    it 'should create an instance of CorrispettiviDetailed' do
      expect(@instance).to be_instance_of(FattureInCloud::CorrispettiviDetailed)
    end
  end
  ...
  describe 'test attribute "importo_lordo"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
