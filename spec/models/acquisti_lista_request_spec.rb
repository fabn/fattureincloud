...
# Unit tests for FattureInCloud::AcquistiListaRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AcquistiListaRequest' do
  before do
    # run before each test
    @instance = FattureInCloud::AcquistiListaRequest.new
  end
  ...
  describe 'test an instance of AcquistiListaRequest' do
    it 'should create an instance of AcquistiListaRequest' do
      expect(@instance).to be_instance_of(FattureInCloud::AcquistiListaRequest)
    end
  end
  ...
  describe 'test attribute "mostra_link_allegato"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
