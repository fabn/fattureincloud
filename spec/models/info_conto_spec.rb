...
# Unit tests for FattureInCloud::InfoConto
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InfoConto' do
  before do
    # run before each test
    @instance = FattureInCloud::InfoConto.new
  end
  ...
  describe 'test an instance of InfoConto' do
    it 'should create an instance of InfoConto' do
      expect(@instance).to be_instance_of(FattureInCloud::InfoConto)
    end
  end
  ...
  describe 'test attribute "nome_conto"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
