...
# Unit tests for FattureInCloud::InfoTemplate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InfoTemplate' do
  before do
    # run before each test
    @instance = FattureInCloud::InfoTemplate.new
  end
  ...
  describe 'test an instance of InfoTemplate' do
    it 'should create an instance of InfoTemplate' do
      expect(@instance).to be_instance_of(FattureInCloud::InfoTemplate)
    end
  end
  ...
  describe 'test attribute "nome_template"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
