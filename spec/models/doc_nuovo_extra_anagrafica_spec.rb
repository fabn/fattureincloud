...
# Unit tests for FattureInCloud::DocNuovoExtraAnagrafica
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DocNuovoExtraAnagrafica' do
  before do
    # run before each test
    @instance = FattureInCloud::DocNuovoExtraAnagrafica.new
  end
  ...
  describe 'test an instance of DocNuovoExtraAnagrafica' do
    it 'should create an instance of DocNuovoExtraAnagrafica' do
      expect(@instance).to be_instance_of(FattureInCloud::DocNuovoExtraAnagrafica)
    end
  end
