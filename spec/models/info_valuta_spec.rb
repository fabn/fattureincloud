...
# Unit tests for FattureInCloud::InfoValuta
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InfoValuta' do
  before do
    # run before each test
    @instance = FattureInCloud::InfoValuta.new
  end
  ...
  describe 'test an instance of InfoValuta' do
    it 'should create an instance of InfoValuta' do
      expect(@instance).to be_instance_of(FattureInCloud::InfoValuta)
    end
  end
  ...
  describe 'test attribute "simbolo"' do
    it 'should work' do
      ...
      #   expect { @instance.simbolo = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "cambio"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
