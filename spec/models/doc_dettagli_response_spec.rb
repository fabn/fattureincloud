...
# Unit tests for FattureInCloud::DocDettagliResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DocDettagliResponse' do
  before do
    # run before each test
    @instance = FattureInCloud::DocDettagliResponse.new
  end
  ...
  describe 'test an instance of DocDettagliResponse' do
    it 'should create an instance of DocDettagliResponse' do
      expect(@instance).to be_instance_of(FattureInCloud::DocDettagliResponse)
    end
  end
