...
# Unit tests for FattureInCloud::DocModificaResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DocModificaResponse' do
  before do
    # run before each test
    @instance = FattureInCloud::DocModificaResponse.new
  end
  ...
  describe 'test an instance of DocModificaResponse' do
    it 'should create an instance of DocModificaResponse' do
      expect(@instance).to be_instance_of(FattureInCloud::DocModificaResponse)
    end
  end
