...
# Unit tests for FattureInCloud::AnagraficaNuovoListaRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AnagraficaNuovoListaRequest' do
  before do
    # run before each test
    @instance = FattureInCloud::AnagraficaNuovoListaRequest.new
  end
  ...
  describe 'test an instance of AnagraficaNuovoListaRequest' do
    it 'should create an instance of AnagraficaNuovoListaRequest' do
      expect(@instance).to be_instance_of(FattureInCloud::AnagraficaNuovoListaRequest)
    end
  end
  describe 'test attribute "lista_soggetti"' do
    it 'should work' do
