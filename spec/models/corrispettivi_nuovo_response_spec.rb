...
# Unit tests for FattureInCloud::CorrispettiviNuovoResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CorrispettiviNuovoResponse' do
  before do
    # run before each test
    @instance = FattureInCloud::CorrispettiviNuovoResponse.new
  end
  ...
  describe 'test an instance of CorrispettiviNuovoResponse' do
    it 'should create an instance of CorrispettiviNuovoResponse' do
      expect(@instance).to be_instance_of(FattureInCloud::CorrispettiviNuovoResponse)
    end
  end
