...
# Unit tests for FattureInCloud::AcquistiNuovoResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AcquistiNuovoResponse' do
  before do
    # run before each test
    @instance = FattureInCloud::AcquistiNuovoResponse.new
  end
  ...
  describe 'test an instance of AcquistiNuovoResponse' do
    it 'should create an instance of AcquistiNuovoResponse' do
      expect(@instance).to be_instance_of(FattureInCloud::AcquistiNuovoResponse)
    end
  end
