...
# Unit tests for FattureInCloud::ArriviArticolo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ArriviArticolo' do
  before do
    # run before each test
    @instance = FattureInCloud::ArriviArticolo.new
  end
  ...
  describe 'test an instance of ArriviArticolo' do
    it 'should create an instance of ArriviArticolo' do
      expect(@instance).to be_instance_of(FattureInCloud::ArriviArticolo)
    end
  end
