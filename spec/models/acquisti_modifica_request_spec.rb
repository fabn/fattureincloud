...
# Unit tests for FattureInCloud::AcquistiModificaRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AcquistiModificaRequest' do
  before do
    # run before each test
    @instance = FattureInCloud::AcquistiModificaRequest.new
  end
  ...
  describe 'test an instance of AcquistiModificaRequest' do
    it 'should create an instance of AcquistiModificaRequest' do
      expect(@instance).to be_instance_of(FattureInCloud::AcquistiModificaRequest)
    end
  end
