...
# Unit tests for FattureInCloud::CorrispettiviModificaRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CorrispettiviModificaRequest' do
  before do
    # run before each test
    @instance = FattureInCloud::CorrispettiviModificaRequest.new
  end
  ...
  describe 'test an instance of CorrispettiviModificaRequest' do
    it 'should create an instance of CorrispettiviModificaRequest' do
      expect(@instance).to be_instance_of(FattureInCloud::CorrispettiviModificaRequest)
    end
  end
  ...
  describe 'test attribute "tipo"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["ricevute", "scontrini"])
  ...
  describe 'test attribute "protocollo_auto"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "protocollo"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "importi_ivati"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "lista_righe"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
