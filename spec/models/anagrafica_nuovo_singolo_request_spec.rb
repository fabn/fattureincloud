...
# Unit tests for FattureInCloud::AnagraficaNuovoSingoloRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AnagraficaNuovoSingoloRequest' do
  before do
    # run before each test
    @instance = FattureInCloud::AnagraficaNuovoSingoloRequest.new
  end
  ...
  describe 'test an instance of AnagraficaNuovoSingoloRequest' do
    it 'should create an instance of AnagraficaNuovoSingoloRequest' do
      expect(@instance).to be_instance_of(FattureInCloud::AnagraficaNuovoSingoloRequest)
    end
  end
  ...
  describe 'test attribute "termini_pagamento"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "pagamento_fine_mese"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "cod_iva_default"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
