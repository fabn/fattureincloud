...
# Unit tests for FattureInCloud::CorrispettiviNuovoRiga
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CorrispettiviNuovoRiga' do
  before do
    # run before each test
    @instance = FattureInCloud::CorrispettiviNuovoRiga.new
  end
  ...
  describe 'test an instance of CorrispettiviNuovoRiga' do
    it 'should create an instance of CorrispettiviNuovoRiga' do
      expect(@instance).to be_instance_of(FattureInCloud::CorrispettiviNuovoRiga)
    end
  end
