...
# Unit tests for FattureInCloud::DocInfoRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DocInfoRequest' do
  before do
    # run before each test
    @instance = FattureInCloud::DocInfoRequest.new
  end
  ...
  describe 'test an instance of DocInfoRequest' do
    it 'should create an instance of DocInfoRequest' do
      expect(@instance).to be_instance_of(FattureInCloud::DocInfoRequest)
    end
  end
