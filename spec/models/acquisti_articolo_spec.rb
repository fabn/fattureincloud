...
# Unit tests for FattureInCloud::AcquistiArticolo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AcquistiArticolo' do
  before do
    # run before each test
    @instance = FattureInCloud::AcquistiArticolo.new
  end
  ...
  describe 'test an instance of AcquistiArticolo' do
    it 'should create an instance of AcquistiArticolo' do
      expect(@instance).to be_instance_of(FattureInCloud::AcquistiArticolo)
    end
  end
