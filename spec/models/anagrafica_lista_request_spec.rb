...
# Unit tests for FattureInCloud::AnagraficaListaRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AnagraficaListaRequest' do
  before do
    # run before each test
    @instance = FattureInCloud::AnagraficaListaRequest.new
  end
  ...
  describe 'test an instance of AnagraficaListaRequest' do
    it 'should create an instance of AnagraficaListaRequest' do
      expect(@instance).to be_instance_of(FattureInCloud::AnagraficaListaRequest)
    end
  end
