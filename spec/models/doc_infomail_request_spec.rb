...
# Unit tests for FattureInCloud::DocInfomailRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DocInfomailRequest' do
  before do
    # run before each test
    @instance = FattureInCloud::DocInfomailRequest.new
  end
  ...
  describe 'test an instance of DocInfomailRequest' do
    it 'should create an instance of DocInfomailRequest' do
      expect(@instance).to be_instance_of(FattureInCloud::DocInfomailRequest)
    end
  end
