...
# Unit tests for FattureInCloud::ArriviListaResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ArriviListaResponse' do
  before do
    # run before each test
    @instance = FattureInCloud::ArriviListaResponse.new
  end
  ...
  describe 'test an instance of ArriviListaResponse' do
    it 'should create an instance of ArriviListaResponse' do
      expect(@instance).to be_instance_of(FattureInCloud::ArriviListaResponse)
    end
  end
