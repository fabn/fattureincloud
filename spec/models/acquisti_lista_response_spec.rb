...
# Unit tests for FattureInCloud::AcquistiListaResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AcquistiListaResponse' do
  before do
    # run before each test
    @instance = FattureInCloud::AcquistiListaResponse.new
  end
  ...
  describe 'test an instance of AcquistiListaResponse' do
    it 'should create an instance of AcquistiListaResponse' do
      expect(@instance).to be_instance_of(FattureInCloud::AcquistiListaResponse)
    end
  end
