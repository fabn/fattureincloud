...
# Unit tests for FattureInCloud::AcquistiModificaResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AcquistiModificaResponse' do
  before do
    # run before each test
    @instance = FattureInCloud::AcquistiModificaResponse.new
  end
  ...
  describe 'test an instance of AcquistiModificaResponse' do
    it 'should create an instance of AcquistiModificaResponse' do
      expect(@instance).to be_instance_of(FattureInCloud::AcquistiModificaResponse)
    end
  end
