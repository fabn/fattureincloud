...
# Unit tests for FattureInCloud::ProdottiNuovoListaRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProdottiNuovoListaRequest' do
  before do
    # run before each test
    @instance = FattureInCloud::ProdottiNuovoListaRequest.new
  end
  ...
  describe 'test an instance of ProdottiNuovoListaRequest' do
    it 'should create an instance of ProdottiNuovoListaRequest' do
      expect(@instance).to be_instance_of(FattureInCloud::ProdottiNuovoListaRequest)
    end
  end
