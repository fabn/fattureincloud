...
# Unit tests for FattureInCloud::ProdottiListaRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProdottiListaRequest' do
  before do
    # run before each test
    @instance = FattureInCloud::ProdottiListaRequest.new
  end
  ...
  describe 'test an instance of ProdottiListaRequest' do
    it 'should create an instance of ProdottiListaRequest' do
      expect(@instance).to be_instance_of(FattureInCloud::ProdottiListaRequest)
    end
  end
