...
# Unit tests for FattureInCloud::AcquistiLight
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AcquistiLight' do
  before do
    # run before each test
    @instance = FattureInCloud::AcquistiLight.new
  end
  ...
  describe 'test an instance of AcquistiLight' do
    it 'should create an instance of AcquistiLight' do
      expect(@instance).to be_instance_of(FattureInCloud::AcquistiLight)
    end
  end
