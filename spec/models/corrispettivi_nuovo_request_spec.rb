...
# Unit tests for FattureInCloud::CorrispettiviNuovoRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CorrispettiviNuovoRequest' do
  before do
    # run before each test
    @instance = FattureInCloud::CorrispettiviNuovoRequest.new
  end
  ...
  describe 'test an instance of CorrispettiviNuovoRequest' do
    it 'should create an instance of CorrispettiviNuovoRequest' do
      expect(@instance).to be_instance_of(FattureInCloud::CorrispettiviNuovoRequest)
    end
  end
