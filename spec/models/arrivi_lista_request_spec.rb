...
# Unit tests for FattureInCloud::ArriviListaRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ArriviListaRequest' do
  before do
    # run before each test
    @instance = FattureInCloud::ArriviListaRequest.new
  end
  ...
  describe 'test an instance of ArriviListaRequest' do
    it 'should create an instance of ArriviListaRequest' do
      expect(@instance).to be_instance_of(FattureInCloud::ArriviListaRequest)
    end
  end
