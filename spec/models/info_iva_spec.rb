...
# Unit tests for FattureInCloud::InfoIva
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InfoIva' do
  before do
    # run before each test
    @instance = FattureInCloud::InfoIva.new
  end
  ...
  describe 'test an instance of InfoIva' do
    it 'should create an instance of InfoIva' do
      expect(@instance).to be_instance_of(FattureInCloud::InfoIva)
    end
  end
  ...
  describe 'test attribute "descrizione_iva"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
