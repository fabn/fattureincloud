...
# Unit tests for FattureInCloud::AnagraficaCliente
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AnagraficaCliente' do
  before do
    # run before each test
    @instance = FattureInCloud::AnagraficaCliente.new
  end
  ...
  describe 'test an instance of AnagraficaCliente' do
    it 'should create an instance of AnagraficaCliente' do
      expect(@instance).to be_instance_of(FattureInCloud::AnagraficaCliente)
    end
  end
  ...
  describe 'test attribute "val_iva_default"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "desc_iva_default"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
