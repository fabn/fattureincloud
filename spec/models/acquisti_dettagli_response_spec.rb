...
# Unit tests for FattureInCloud::AcquistiDettagliResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AcquistiDettagliResponse' do
  before do
    # run before each test
    @instance = FattureInCloud::AcquistiDettagliResponse.new
  end
  ...
  describe 'test an instance of AcquistiDettagliResponse' do
    it 'should create an instance of AcquistiDettagliResponse' do
      expect(@instance).to be_instance_of(FattureInCloud::AcquistiDettagliResponse)
    end
  end
  ...
  describe 'test attribute "dettagli_documento"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
