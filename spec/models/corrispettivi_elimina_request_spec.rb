...
# Unit tests for FattureInCloud::CorrispettiviEliminaRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CorrispettiviEliminaRequest' do
  before do
    # run before each test
    @instance = FattureInCloud::CorrispettiviEliminaRequest.new
  end
  ...
  describe 'test an instance of CorrispettiviEliminaRequest' do
    it 'should create an instance of CorrispettiviEliminaRequest' do
      expect(@instance).to be_instance_of(FattureInCloud::CorrispettiviEliminaRequest)
    end
  end
