...
# Unit tests for FattureInCloud::AnagraficaNuovoSingoloResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AnagraficaNuovoSingoloResponse' do
  before do
    # run before each test
    @instance = FattureInCloud::AnagraficaNuovoSingoloResponse.new
  end
  ...
  describe 'test an instance of AnagraficaNuovoSingoloResponse' do
    it 'should create an instance of AnagraficaNuovoSingoloResponse' do
      expect(@instance).to be_instance_of(FattureInCloud::AnagraficaNuovoSingoloResponse)
    end
  end
