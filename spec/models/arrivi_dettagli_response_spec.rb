...
# Unit tests for FattureInCloud::ArriviDettagliResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ArriviDettagliResponse' do
  before do
    # run before each test
    @instance = FattureInCloud::ArriviDettagliResponse.new
  end
  ...
  describe 'test an instance of ArriviDettagliResponse' do
    it 'should create an instance of ArriviDettagliResponse' do
      expect(@instance).to be_instance_of(FattureInCloud::ArriviDettagliResponse)
    end
  end
