...
# Unit tests for FattureInCloud::DocNuovoPagamento
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DocNuovoPagamento' do
  before do
    # run before each test
    @instance = FattureInCloud::DocNuovoPagamento.new
  end
  ...
  describe 'test an instance of DocNuovoPagamento' do
    it 'should create an instance of DocNuovoPagamento' do
      expect(@instance).to be_instance_of(FattureInCloud::DocNuovoPagamento)
    end
  end
