...
# Unit tests for FattureInCloud::DocEliminaRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DocEliminaRequest' do
  before do
    # run before each test
    @instance = FattureInCloud::DocEliminaRequest.new
  end
  ...
  describe 'test an instance of DocEliminaRequest' do
    it 'should create an instance of DocEliminaRequest' do
      expect(@instance).to be_instance_of(FattureInCloud::DocEliminaRequest)
    end
  end
