...
# Unit tests for FattureInCloud::DocListaResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DocListaResponse' do
  before do
    # run before each test
    @instance = FattureInCloud::DocListaResponse.new
  end
  ...
  describe 'test an instance of DocListaResponse' do
    it 'should create an instance of DocListaResponse' do
      expect(@instance).to be_instance_of(FattureInCloud::DocListaResponse)
    end
  end
  ...
  describe 'test attribute "lista_documenti"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "pagina_corrente"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "numero_pagine"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "numero_risultati"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "risultati_per_pagina"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
