...
# Unit tests for FattureInCloud::CorrispettiviListaResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CorrispettiviListaResponse' do
  before do
    # run before each test
    @instance = FattureInCloud::CorrispettiviListaResponse.new
  end
  ...
  describe 'test an instance of CorrispettiviListaResponse' do
    it 'should create an instance of CorrispettiviListaResponse' do
      expect(@instance).to be_instance_of(FattureInCloud::CorrispettiviListaResponse)
    end
  end
  ...
  describe 'test attribute "lista_corrispettivi"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
