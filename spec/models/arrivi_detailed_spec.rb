...
# Unit tests for FattureInCloud::ArriviDetailed
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ArriviDetailed' do
  before do
    # run before each test
    @instance = FattureInCloud::ArriviDetailed.new
  end
  ...
  describe 'test an instance of ArriviDetailed' do
    it 'should create an instance of ArriviDetailed' do
      expect(@instance).to be_instance_of(FattureInCloud::ArriviDetailed)
    end
  end
