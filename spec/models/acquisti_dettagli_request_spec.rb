...
# Unit tests for FattureInCloud::AcquistiDettagliRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AcquistiDettagliRequest' do
  before do
    # run before each test
    @instance = FattureInCloud::AcquistiDettagliRequest.new
  end
  ...
  describe 'test an instance of AcquistiDettagliRequest' do
    it 'should create an instance of AcquistiDettagliRequest' do
      expect(@instance).to be_instance_of(FattureInCloud::AcquistiDettagliRequest)
    end
  end
