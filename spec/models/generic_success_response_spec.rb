...
# Unit tests for FattureInCloud::GenericSuccessResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GenericSuccessResponse' do
  before do
    # run before each test
    @instance = FattureInCloud::GenericSuccessResponse.new
  end
  ...
  describe 'test an instance of GenericSuccessResponse' do
    it 'should create an instance of GenericSuccessResponse' do
      expect(@instance).to be_instance_of(FattureInCloud::GenericSuccessResponse)
    end
  end
