...
# Unit tests for FattureInCloud::ProdottiListaResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProdottiListaResponse' do
  before do
    # run before each test
    @instance = FattureInCloud::ProdottiListaResponse.new
  end
  ...
  describe 'test an instance of ProdottiListaResponse' do
    it 'should create an instance of ProdottiListaResponse' do
      expect(@instance).to be_instance_of(FattureInCloud::ProdottiListaResponse)
    end
  end
  ...
  describe 'test attribute "lista_prodotti"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
