...
# Unit tests for FattureInCloud::DocInfomailMail
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DocInfomailMail' do
  before do
    # run before each test
    @instance = FattureInCloud::DocInfomailMail.new
  end
  ...
  describe 'test an instance of DocInfomailMail' do
    it 'should create an instance of DocInfomailMail' do
      expect(@instance).to be_instance_of(FattureInCloud::DocInfomailMail)
    end
  end
