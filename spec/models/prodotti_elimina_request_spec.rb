...
# Unit tests for FattureInCloud::ProdottiEliminaRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProdottiEliminaRequest' do
  before do
    # run before each test
    @instance = FattureInCloud::ProdottiEliminaRequest.new
  end
  ...
  describe 'test an instance of ProdottiEliminaRequest' do
    it 'should create an instance of ProdottiEliminaRequest' do
      expect(@instance).to be_instance_of(FattureInCloud::ProdottiEliminaRequest)
    end
  end
