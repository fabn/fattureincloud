...
# Unit tests for FattureInCloud::JSONRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'JSONRequest' do
  before do
    # run before each test
    @instance = FattureInCloud::JSONRequest.new
  end
  ...
  describe 'test an instance of JSONRequest' do
    it 'should create an instance of JSONRequest' do
      expect(@instance).to be_instance_of(FattureInCloud::JSONRequest)
    end
  end
  describe 'test attribute "api_uid"' do
    it 'should work' do
