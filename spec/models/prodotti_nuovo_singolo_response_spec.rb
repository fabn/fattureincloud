...
# Unit tests for FattureInCloud::ProdottiNuovoSingoloResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProdottiNuovoSingoloResponse' do
  before do
    # run before each test
    @instance = FattureInCloud::ProdottiNuovoSingoloResponse.new
  end
  ...
  describe 'test an instance of ProdottiNuovoSingoloResponse' do
    it 'should create an instance of ProdottiNuovoSingoloResponse' do
      expect(@instance).to be_instance_of(FattureInCloud::ProdottiNuovoSingoloResponse)
    end
  end
