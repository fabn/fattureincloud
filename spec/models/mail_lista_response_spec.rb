...
# Unit tests for FattureInCloud::MailListaResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MailListaResponse' do
  before do
    # run before each test
    @instance = FattureInCloud::MailListaResponse.new
  end
  ...
  describe 'test an instance of MailListaResponse' do
    it 'should create an instance of MailListaResponse' do
      expect(@instance).to be_instance_of(FattureInCloud::MailListaResponse)
    end
  end
  ...
  describe 'test attribute "lista_mail"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
