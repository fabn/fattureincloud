...
# Unit tests for FattureInCloud::AcquistiEliminaRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AcquistiEliminaRequest' do
  before do
    # run before each test
    @instance = FattureInCloud::AcquistiEliminaRequest.new
  end
  ...
  describe 'test an instance of AcquistiEliminaRequest' do
    it 'should create an instance of AcquistiEliminaRequest' do
      expect(@instance).to be_instance_of(FattureInCloud::AcquistiEliminaRequest)
    end
  end
