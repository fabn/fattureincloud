...
# Unit tests for FattureInCloud::CorrispettiviRiga
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CorrispettiviRiga' do
  before do
    # run before each test
    @instance = FattureInCloud::CorrispettiviRiga.new
  end
  ...
  describe 'test an instance of CorrispettiviRiga' do
    it 'should create an instance of CorrispettiviRiga' do
      expect(@instance).to be_instance_of(FattureInCloud::CorrispettiviRiga)
    end
  end
