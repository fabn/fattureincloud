...
# Unit tests for FattureInCloud::Prodotto
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Prodotto' do
  before do
    # run before each test
    @instance = FattureInCloud::Prodotto.new
  end
  ...
  describe 'test an instance of Prodotto' do
    it 'should create an instance of Prodotto' do
      expect(@instance).to be_instance_of(FattureInCloud::Prodotto)
    end
  end
  ...
  describe 'test attribute "giacenza"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
