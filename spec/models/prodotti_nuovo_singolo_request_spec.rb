...
# Unit tests for FattureInCloud::ProdottiNuovoSingoloRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProdottiNuovoSingoloRequest' do
  before do
    # run before each test
    @instance = FattureInCloud::ProdottiNuovoSingoloRequest.new
  end
  ...
  describe 'test an instance of ProdottiNuovoSingoloRequest' do
    it 'should create an instance of ProdottiNuovoSingoloRequest' do
      expect(@instance).to be_instance_of(FattureInCloud::ProdottiNuovoSingoloRequest)
    end
  end
  ...
  describe 'test attribute "prezzo_ivato"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "costo"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "giacenza_iniziale"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
