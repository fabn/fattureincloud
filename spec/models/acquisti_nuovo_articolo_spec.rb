...
# Unit tests for FattureInCloud::AcquistiNuovoArticolo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AcquistiNuovoArticolo' do
  before do
    # run before each test
    @instance = FattureInCloud::AcquistiNuovoArticolo.new
  end
  ...
  describe 'test an instance of AcquistiNuovoArticolo' do
    it 'should create an instance of AcquistiNuovoArticolo' do
      expect(@instance).to be_instance_of(FattureInCloud::AcquistiNuovoArticolo)
    end
  end
