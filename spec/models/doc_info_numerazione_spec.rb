...
# Unit tests for FattureInCloud::DocInfoNumerazione
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DocInfoNumerazione' do
  before do
    # run before each test
    @instance = FattureInCloud::DocInfoNumerazione.new
  end
  ...
  describe 'test an instance of DocInfoNumerazione' do
    it 'should create an instance of DocInfoNumerazione' do
      expect(@instance).to be_instance_of(FattureInCloud::DocInfoNumerazione)
    end
  end
  describe 'test attribute "serie1"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "serie2"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "serie_n"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
