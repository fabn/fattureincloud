...
# Unit tests for FattureInCloud::ArriviLight
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ArriviLight' do
  before do
    # run before each test
    @instance = FattureInCloud::ArriviLight.new
  end
  ...
  describe 'test an instance of ArriviLight' do
    it 'should create an instance of ArriviLight' do
      expect(@instance).to be_instance_of(FattureInCloud::ArriviLight)
    end
  end
