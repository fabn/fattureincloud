...
# Unit tests for FattureInCloud::AnagraficaListaResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AnagraficaListaResponse' do
  before do
    # run before each test
    @instance = FattureInCloud::AnagraficaListaResponse.new
  end
  ...
  describe 'test an instance of AnagraficaListaResponse' do
    it 'should create an instance of AnagraficaListaResponse' do
      expect(@instance).to be_instance_of(FattureInCloud::AnagraficaListaResponse)
    end
  end
  ...
  describe 'test attribute "lista_clienti"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "lista_fornitori"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
