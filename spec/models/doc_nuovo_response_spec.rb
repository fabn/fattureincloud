...
# Unit tests for FattureInCloud::DocNuovoResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DocNuovoResponse' do
  before do
    # run before each test
    @instance = FattureInCloud::DocNuovoResponse.new
  end
  ...
  describe 'test an instance of DocNuovoResponse' do
    it 'should create an instance of DocNuovoResponse' do
      expect(@instance).to be_instance_of(FattureInCloud::DocNuovoResponse)
    end
  end
