...
describe FattureInCloud::Configuration do
  let(:config) { FattureInCloud::Configuration.default }

  before(:each) do
    # uncomment below to setup host and base_path
    # require 'URI'
    # uri = URI.parse("https://api.fattureincloud.it/v1")
    # FattureInCloud.configure do |c|
    #   c.host = uri.host
  ...
  describe '#base_url' do
    it 'should have the default value' do
      ...
      # expect(config.base_url).to eq("https://api.fattureincloud.it/v1")
    end
