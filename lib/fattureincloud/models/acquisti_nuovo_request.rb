...
module FattureInCloud
  class AcquistiNuovoRequest
    ...
    def hash
      [tipo, id_fornitore, nome, piva, cf, autocompila_anagrafica, salva_anagrafica, descrizione, categoria, importo_netto, importo_iva, valuta, valuta_cambio, ritenuta_acconto, ritenuta_previdenziale, deducibilita_tasse, detraibilita_iva, ammortamento, centro_costo, numero_fattura, lista_pagamenti, lista_articoli].hash
    end
