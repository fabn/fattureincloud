...
module FattureInCloud
  class AcquistiDetailed
    ...
    def list_invalid_properties
      ...
      if @ritenuta_acconto.nil?
        invalid_properties.push('invalid value for "ritenuta_acconto", ritenuta_acconto cannot be nil.')
      end

      if @ritenuta_previdenziale.nil?
        invalid_properties.push('invalid value for "ritenuta_previdenziale", ritenuta_previdenziale cannot be nil.')
      end

      if @deducibilita_tasse.nil?
        invalid_properties.push('invalid value for "deducibilita_tasse", deducibilita_tasse cannot be nil.')
      end

      if @detraibilita_iva.nil?
        invalid_properties.push('invalid value for "detraibilita_iva", detraibilita_iva cannot be nil.')
      end

      if @ammortamento.nil?
        invalid_properties.push('invalid value for "ammortamento", ammortamento cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ritenuta_acconto.nil?
      return false if @ritenuta_previdenziale.nil?
      return false if @deducibilita_tasse.nil?
      return false if @detraibilita_iva.nil?
      return false if @ammortamento.nil?
    ...
    def hash
      [id, tipo, id_fornitore, nome, descrizione, categoria, importo_netto, importo_iva, importo_totale, valuta, valuta_cambio, link_allegato, ritenuta_acconto, ritenuta_previdenziale, deducibilita_tasse, detraibilita_iva, ammortamento, centro_costo, numero_fattura, lista_pagamenti, lista_articoli].hash
    end
