...
module FattureInCloud
  class ProdottiModificaRequest
    ...
    # Specifica se il prezzo da registrare è calcolato sulla base del prezzo lordo (true) oppure se è calcolato sulla base del prezzo netto (false).
    ...
    def hash
      [id, cod, nome, desc, prezzo_ivato, prezzo_netto, prezzo_lordo, costo, cod_iva, um, categoria, note, magazzino, giacenza_iniziale].hash
    end
