...
module FattureInCloud
  class ProdottiNuovoSingoloRequest
    # Codice prodotto
    attr_accessor :cod
    ...
    def hash
      [cod, nome, desc, prezzo_ivato, prezzo_netto, prezzo_lordo, costo, cod_iva, um, categoria, note, magazzino, giacenza_iniziale].hash
    end
