...
module FattureInCloud
  class DocModificaResponse
    attr_accessor :success

    # Nuovo identificativo del documento modificato [Cambia alla modifica]
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'new_id')
        self.new_id = attributes[:'new_id']
      end
    ...
    def list_invalid_properties
      ...
      if @new_id.nil?
        invalid_properties.push('invalid value for "new_id", new_id cannot be nil.')
      end
