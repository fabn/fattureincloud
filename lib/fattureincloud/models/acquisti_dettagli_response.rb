...
module FattureInCloud
  class AcquistiDettagliResponse
    attr_accessor :success

    attr_accessor :dettagli_documento

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'success' => :'success',
        :'dettagli_documento' => :'dettagli_documento'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'dettagli_documento')
        self.dettagli_documento = attributes[:'dettagli_documento']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @dettagli_documento.nil?
        invalid_properties.push('invalid value for "dettagli_documento", dettagli_documento cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @dettagli_documento.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          success == o.success &&
          dettagli_documento == o.dettagli_documento
    end
    ...
    def hash
      [success, dettagli_documento].hash
    end
