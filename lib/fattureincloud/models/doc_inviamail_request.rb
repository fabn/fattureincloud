  ...
  class DocInviamailRequest
    ...
    def self.attribute_map
      {
        ...
        :'oggetto' => :'oggetto',
        :'messaggio' => :'messaggio',
        :'includi_documento' => :'includi_documento',
        :'invia_ddt' => :'invia_ddt',
        :'invia_fa' => :'invia_fa',
        :'includi_allegato' => :'includi_allegato',
        :'invia_copia' => :'invia_copia',
        :'allega_pdf' => :'allega_pdf'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'mail_mittente')
        ...
        self.mail_mittente = 'no-reply@fattureincloud.it'
      end

      if attributes.has_key?(:'mail_destinatario')
        self.mail_destinatario = attributes[:'mail_destinatario']
      else
        self.mail_destinatario = 'prova@example.it'
      end

      if attributes.has_key?(:'oggetto')
        self.oggetto = attributes[:'oggetto']
      else
        self.oggetto = 'Oggetto esempio'
      end

      if attributes.has_key?(:'messaggio')
        self.messaggio = attributes[:'messaggio']
      else
        self.messaggio = 'Messaggio esempio'
      end

      if attributes.has_key?(:'includi_documento')
        self.includi_documento = attributes[:'includi_documento']
      else
        self.includi_documento = true
      end

      if attributes.has_key?(:'invia_ddt')
        self.invia_ddt = attributes[:'invia_ddt']
      else
        self.invia_ddt = true
      end

      if attributes.has_key?(:'invia_fa')
        self.invia_fa = attributes[:'invia_fa']
      else
        self.invia_fa = true
      end

      if attributes.has_key?(:'includi_allegato')
        self.includi_allegato = attributes[:'includi_allegato']
      else
        self.includi_allegato = true
      end

      if attributes.has_key?(:'invia_copia')
        self.invia_copia = attributes[:'invia_copia']
      else
        self.invia_copia = true
      end

      if attributes.has_key?(:'allega_pdf')
        self.allega_pdf = attributes[:'allega_pdf']
      else
        self.allega_pdf = true
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          includi_documento == o.includi_documento &&
          invia_ddt == o.invia_ddt &&
          invia_fa == o.invia_fa &&
          includi_allegato == o.includi_allegato &&
          invia_copia == o.invia_copia &&
          allega_pdf == o.allega_pdf
    end
    ...
    def hash
      [id, token, mail_mittente, mail_destinatario, oggetto, messaggio, includi_documento, invia_ddt, invia_fa, includi_allegato, invia_copia, allega_pdf].hash
    end
