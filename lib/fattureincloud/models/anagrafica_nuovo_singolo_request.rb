...
module FattureInCloud
  class AnagraficaNuovoSingoloRequest
    ...
    def hash
      [nome, referente, indirizzo_via, indirizzo_cap, indirizzo_citta, indirizzo_provincia, indirizzo_extra, paese, paese_iso, mail, tel, fax, piva, cf, termini_pagamento, pagamento_fine_mese, cod_iva_default, extra, pa, pa_codice].hash
    end
