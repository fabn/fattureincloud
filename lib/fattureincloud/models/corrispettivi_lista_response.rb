...
module FattureInCloud
  class CorrispettiviListaResponse
    attr_accessor :success

    attr_accessor :lista_corrispettivi

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'success' => :'success',
        :'lista_corrispettivi' => :'lista_corrispettivi'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'lista_corrispettivi')
        if (value = attributes[:'lista_corrispettivi']).is_a?(Array)
          self.lista_corrispettivi = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @lista_corrispettivi.nil?
        invalid_properties.push('invalid value for "lista_corrispettivi", lista_corrispettivi cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @lista_corrispettivi.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          success == o.success &&
          lista_corrispettivi == o.lista_corrispettivi
    end
    ...
    def hash
      [success, lista_corrispettivi].hash
    end
