...
module FattureInCloud
  class InfoTemplate
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'nome_template')
        self.nome_template = attributes[:'nome_template']
      else
        self.nome_template = 'New Standard S1'
      end
    end
    ...
    def list_invalid_properties
      ...
      if @nome_template.nil?
        invalid_properties.push('invalid value for "nome_template", nome_template cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @nome_template.nil?
      true
    end
