...
module FattureInCloud
  class InfoIva
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'descrizione_iva')
        self.descrizione_iva = attributes[:'descrizione_iva']
      else
        self.descrizione_iva = ''
      end
    end
    ...
    def list_invalid_properties
      ...
      if @descrizione_iva.nil?
        invalid_properties.push('invalid value for "descrizione_iva", descrizione_iva cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @descrizione_iva.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          descrizione_iva == o.descrizione_iva
    end
    ...
    def hash
      [cod_iva, valore_iva, descrizione_iva].hash
    end
