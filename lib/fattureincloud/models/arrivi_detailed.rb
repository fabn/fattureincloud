...
module FattureInCloud
  class ArriviDetailed
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'numero_ddt')
    ...
    def hash
      [id, id_fornitore, nome, descrizione, categoria, importo_netto, importo_iva, importo_totale, valuta, valuta_cambio, link_allegato, numero_ddt, lista_articoli].hash
    end
