...
module FattureInCloud
  class JSONRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'api_uid')
        self.api_uid = attributes[:'api_uid']
      else
        self.api_uid = ''
      end
    ...
    def list_invalid_properties
      ...
      if @api_uid.nil?
        invalid_properties.push('invalid value for "api_uid", api_uid cannot be nil.')
      end
