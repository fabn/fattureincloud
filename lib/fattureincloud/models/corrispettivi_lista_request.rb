...
module FattureInCloud
  class CorrispettiviListaRequest
    attr_accessor :anno

    # Specifica il tipo di registrazioni da cercare
    attr_accessor :tipo
    ...
    def valid?
      ...
      tipo_validator = EnumAttributeValidator.new('String', ['ricevute', 'spese'])
    ...
    def tipo=(tipo)
      validator = EnumAttributeValidator.new('String', ['ricevute', 'spese'])
