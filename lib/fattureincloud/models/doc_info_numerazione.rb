...
module FattureInCloud
  class DocInfoNumerazione
    # Numero suggerito per la creazione di un documento del tipo specificato e per la serie &lt;serie1&gt; (ottenuto come: massimo dell'anno +1)
    attr_accessor :serie1

    # Numero suggerito per la creazione di un documento del tipo specificato e per la serie &lt;serie2&gt; (ottenuto come: massimo dell'anno +1)
    attr_accessor :serie2
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'<serie1>')
        self.serie1 = attributes[:'<serie1>']
      else
        self.serie1 = 1
      end

      if attributes.has_key?(:'<serie2>')
        self.serie2 = attributes[:'<serie2>']
      else
        self.serie2 = 1
      end

      if attributes.has_key?(:'<serieN>')
        self.serie_n = attributes[:'<serieN>']
      else
        self.serie_n = 1
      end
    end
