...
module FattureInCloud
  class InfoValuta
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'simbolo')
        self.simbolo = attributes[:'simbolo']
      else
        self.simbolo = '€'
      end

      if attributes.has_key?(:'cambio')
        self.cambio = attributes[:'cambio']
      else
        self.cambio = '1.00000'
      end
    end
    ...
    def list_invalid_properties
      ...
      if @simbolo.nil?
        invalid_properties.push('invalid value for "simbolo", simbolo cannot be nil.')
      end

      if @cambio.nil?
        invalid_properties.push('invalid value for "cambio", cambio cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @simbolo.nil?
      simbolo_validator = EnumAttributeValidator.new('String', ['in_coda', 'in_corso', 'inviato', 'fallito'])
      return false unless simbolo_validator.valid?(@simbolo)
      return false if @cambio.nil?
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] simbolo Object to be assigned
    def simbolo=(simbolo)
      validator = EnumAttributeValidator.new('String', ['in_coda', 'in_corso', 'inviato', 'fallito'])
      unless validator.valid?(simbolo)
        fail ArgumentError, 'invalid value for "simbolo", must be one of #{validator.allowable_values}.'
      end
      @simbolo = simbolo
    end
