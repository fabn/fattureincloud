...
module FattureInCloud
  class DocListaResponse
    attr_accessor :success

    attr_accessor :lista_documenti
    ...
    attr_accessor :numero_risultati

    # Numero massimo di risultati presenti in ogni pagina
    attr_accessor :risultati_per_pagina
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'lista_documenti')
        if (value = attributes[:'lista_documenti']).is_a?(Array)
          self.lista_documenti = value
        end
      end
      ...
      if attributes.has_key?(:'numero_risultati')
        self.numero_risultati = attributes[:'numero_risultati']
      else
        self.numero_risultati = 0
      end

      if attributes.has_key?(:'risultati_per_pagina')
        self.risultati_per_pagina = attributes[:'risultati_per_pagina']
      else
        self.risultati_per_pagina = 250
      end
    end
    ...
    def list_invalid_properties
      ...
      if @lista_documenti.nil?
        invalid_properties.push('invalid value for "lista_documenti", lista_documenti cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @lista_documenti.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          success == o.success &&
          lista_documenti == o.lista_documenti &&
          pagina_corrente == o.pagina_corrente &&
          numero_pagine == o.numero_pagine &&
          numero_risultati == o.numero_risultati &&
          risultati_per_pagina == o.risultati_per_pagina
    end
    ...
    def hash
      [success, lista_documenti, pagina_corrente, numero_pagine, numero_risultati, risultati_per_pagina].hash
    end
