...
module FattureInCloud
  class InfoConto
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'nome_conto')
        self.nome_conto = attributes[:'nome_conto']
      else
        self.nome_conto = 'Mio Conto Bancario'
      end
    end
    ...
    def list_invalid_properties
      ...
      if @nome_conto.nil?
        invalid_properties.push('invalid value for "nome_conto", nome_conto cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @nome_conto.nil?
      true
    end
