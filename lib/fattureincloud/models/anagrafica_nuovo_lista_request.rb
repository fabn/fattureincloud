...
module FattureInCloud
  class AnagraficaNuovoListaRequest
    # Lista dei clienti o fornitori da inserire
    attr_accessor :lista_soggetti

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'lista_soggetti' => :'lista_soggetti'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'lista_soggetti')
        if (value = attributes[:'lista_soggetti']).is_a?(Array)
          self.lista_soggetti = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @lista_soggetti.nil?
        invalid_properties.push('invalid value for "lista_soggetti", lista_soggetti cannot be nil.')
      end
    ...
    def valid?
      return false if @lista_soggetti.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          lista_soggetti == o.lista_soggetti
    end
