...
module FattureInCloud
  class MailApi
    ...
    # @return [MailListaResponse]
    def mail_lista(body, opts = {})
      data, _status_code, _headers = mail_lista_with_http_info(body, opts)
      data
    end
    ...
    # @param body Corpo richiesta
    # @param [Hash] opts the optional parameters
    # @return [Array<(MailListaResponse, Fixnum, Hash)>] MailListaResponse data, response status code and response headers
    def mail_lista_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MailApi.mail_lista ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling MailApi.mail_lista"
      end
      # resource path
      local_var_path = '/mail/lista'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'MailListaResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MailApi#mail_lista\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
